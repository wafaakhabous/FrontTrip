...
const BlogCardRight = ({firstname, lastname, datestart, dateend, itineraries}) => {
    const showMore = () => {
        window.location.href = '/Blogs'
    }
    return (
        <Row>
            <Col span={13} style={{backgroundColor : 'white', height: 400}}>
                <Row className='mt-4'>
                    <Col span={24} style={{fontFamily : 'Lora'}}>
                        <Row className='flex align-items-center'>
                            ...
                            <Col span={10} style={{fontFamily : 'Work Sans', right: 45}}>
